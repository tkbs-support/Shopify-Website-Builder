...
settings = data["sections"]["collection-list"]["settings"]
print(f"  Before: expand_collection = {settings.get('expand_collection')}")
settings["expand_collection"] = False
print(f"  After:  expand_collection = {settings.get('expand_collection')}")
